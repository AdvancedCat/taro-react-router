...
export default function Index() {
  ...
  return (
    <MyRouter basename="pages/nested-route/index">
  ...
  return (
    <View>
      ...
      <View className="at-article__p">
        使用 hook useParams() 可以获取到路由参数 /:invoiceId
      </View>
      <p>Invoice ID: {invoiceId}</p>
      <p>Invoice name: {invoiceList[invoiceId].name}</p>
      <p>
        Invoice created time:{" "}
        {new Date(invoiceList[+invoiceId].created).toString()}
      </p>
    </View>
  );
}
